...
return from;}
return-1;};}
jQuery(document).ready(function(){jQuery('.amcharts-tooltip').tooltip();jQuery('.m-nav-opener').click(function(event){event.preventDefault();jQuery('.app').toggleClass('m-nav-open');return false;});jQuery('.app-body').click(function(){if(jQuery('.app').hasClass('m-nav-open'))
